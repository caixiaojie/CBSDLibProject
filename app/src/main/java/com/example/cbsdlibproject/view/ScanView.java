package com.example.cbsdlibproject.view;
...
import com.example.cbsdlibproject.R;
...
// 帮助消除锯齿
        mPaintCircleOrLine.setFlags(Paint.ANTI_ALIAS_FLAG);
        ...
        mPaintArc1.setStyle(Paint.Style.STROKE);
        mPaintArc1.setStrokeWidth(10);
        mPaintArc1.setAntiAlias(true);
        mPaintArc1.setFlags(Paint.ANTI_ALIAS_FLAG);
        mPaintArc1.setStrokeCap(Paint.Cap.ROUND);
        mPaintArc1.setColor(getResources().getColor(R.color.colorArcBorder));


        mPaintArc2 = new Paint();

        mPaintArc2.setStrokeWidth(10);

        mPaintArc2.setStyle(Paint.Style.STROKE);

        mPaintArc2.setAntiAlias(true);
        mPaintArc2.setFlags(Paint.ANTI_ALIAS_FLAG);
        mPaintArc2.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        SweepGradient sweepGradient1 = new SweepGradient(mWidth / 2, mHeight / 2,
                ...
                new int[]{Color.TRANSPARENT, getResources().getColor(R.color.colorArcBorder)}, new float[]{0.8f, 1f});
...
//        canvas.drawCircle(mWidth / 2, mHeight / 2, (mWidth - getPaddingLeft() - getPaddingRight()) / 2, mPaintCircleOrLine);
    ...
    private void canvasArc(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, 0, 180, false, mPaintArc1);
            ...
            while (threadRunning) {
                ...
                view.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        matrix.preRotate(start, mWidth / 2, mHeight / 2);
                        view.invalidate();
