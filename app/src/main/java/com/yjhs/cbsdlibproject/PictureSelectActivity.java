...
public class PictureSelectActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(PictureSelectActivity.this, 4, GridLayoutManager.VERTICAL, false);
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(PictureSelectActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(MainActivity.this)
                        ...
                        .withAspectRatio(aspect_ratio_x, aspect_ratio_y)// 裁剪比例 如16:9 3:2 3:4 bg:bg 可自定义
...
//                        .videoMinSecond(10)
    ...
    private void showPop() {
        View bottomView = View.inflate(PictureSelectActivity.this, R.layout.layout_bottom_dialog, null);
