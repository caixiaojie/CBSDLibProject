package com.yjhs.cbsdlib.ui.adapters.wrapper;
...
import com.yjhs.cbsdlib.ui.adapters.CommonHolder;
...
public class EmptyWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean isEmpty() {
        return (mEmptyView != null || mEmptyLayoutId != 0) && (mInnerAdapter.getItemCount() == 0 && !isLoading());
    }
