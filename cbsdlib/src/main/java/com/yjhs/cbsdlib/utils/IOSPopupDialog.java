...
public class IOSPopupDialog extends AlertDialog {

    private static final String TAG = "IOSPopupDialog";
    ...
    protected IOSPopupDialog(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
     ...
     * @return IOSPopupDialog

     */

    public static IOSPopupDialog create(Context context, String title, String message, String confirm, View.OnClickListener
        ...
        IOSPopupDialog dialog = new IOSPopupDialog(context, cancelable, canceledOnTouchOutside);
    ...
    public static IOSPopupDialog create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
